        ...
        <div class="h-full w-full">
            <form class="flex flex-col h-full justify-between max-w-sm mx-auto text-center" action="/" method="post">
                ...
                <div class="flex flex-col mb-5">
                    ...
                    <input type="text" name="serial" class="block uppercase text-6xl text-center w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 text-base focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" autofocus>
